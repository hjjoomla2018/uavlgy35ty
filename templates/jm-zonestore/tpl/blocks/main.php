...
// show/hide columns for item view of DJ-Catalog2
$input = JFactory::getApplication()->input;
$view = $input->get('view');
$component = $input->get('option');
$productColumn = $this->params->get('productColumn', '1');
$column = ( $component=='com_djcatalog2' && $view=='item' && $productColumn=='0' ) ? false : true;
if( ! $column ) {
...
<div id="jm-main" class="<?php echo $this->getClass('block#main') ?>" <?php if($highContrast) echo 'tabindex="-1"'; ?>>
