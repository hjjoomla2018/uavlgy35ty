...
$djMediaTools = ($this->params->get('djmediatools_integration', 0) == '1' && $this->params->get('djmediatools_album_producer', 0) > 0) ? $this->params->get('djmediatools_album_producer', 0) : false;
...
<div class="djc_images-mediatools">
	<?php echo JHtml::_('content.prepare', '{djmedia '.(int)$djMediaTools.'}', $this->params, 'com_djcatalog2.producer.djmediatools'); ?>
</div>
<?php } else { ?>
<?php 
