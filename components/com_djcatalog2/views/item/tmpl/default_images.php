...
<div class="djc_images-mediatools">
	<?php echo JHtml::_('content.prepare', '{djmedia '.(int)$djMediaTools.'}', $this->params, 'com_djcatalog2.item.djmediatools'); ?>
</div>
<?php } else { ?>
<?php 
	...
	<div class="djc_mainimage">
		<?php if ($imageSwitcher) {?>
			<a data-target="main-image-link" data-thumb="0" title="<?php echo $this->item->images[0]->caption; ?>" href="<?php echo $this->item->images[0]->$fullscreenVar; ?>">
				<img itemprop="image" class="img-polaroid" alt="<?php echo $this->item->images[0]->caption; ?>" src="<?php echo $this->item->images[0]->large; ?>" />
			</a>
		<?php } else { ?>
			<a class="djimagebox" title="<?php echo $this->item->images[0]->caption; ?>" href="<?php echo $this->item->images[0]->$fullscreenVar; ?>">
				<img itemprop="image" id="djc_mainimage" class="img-polaroid" alt="<?php echo $this->item->images[0]->caption; ?>" src="<?php echo $this->item->images[0]->large; ?>" />
			</a>
		<?php } ?>
	</div>
	<?php } ?>
