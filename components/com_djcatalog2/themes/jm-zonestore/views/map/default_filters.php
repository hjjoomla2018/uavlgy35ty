	...
	<form name="djcatalogForm" id="djcatalogForm" method="post" action="<?php echo JRoute::_('index.php?option=com_djcatalog2&task=mapsearch'); ?>">
		...
		<?php if ((int)$this->params->get('show_search_map', 1) > 0) { ?>
			<ul class="djc_filter_ul djc_filter_map_search djc_clearfix">
				<li class="djc_filter_label"><span><?php echo JText::_('COM_DJCATALOG2_SEARCH_BY_ADDRESS'); ?></span></li>
			...
			<ul class="djc_filter_ul djc_filter_radius_search djc_filter_map_search djc_filter_radius djc_clearfix">
			...
			<ul class="djc_filter_ul djc_filter_buttons djc_clearfix">
				...
				<li class="djc_filter_button djc_filter_button djc_filter_button_reset"><input type="submit" class="button btn djc_filter_reset_btn" onclick="document.getElementById('djcatsearch').value='';document.djcatalogForm.submit();" value="<?php echo JText::_( 'COM_DJCATALOG2_RESET' ); ?>" /></li>
			</ul>
		<?php } ?>
