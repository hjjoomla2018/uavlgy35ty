...
<table cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        ?><h2><?php echo JText::_('COM_DJCATALOG2_ORDER_INVOICE_NUMBER') ?> <?php echo $data->invoice_number; ?></h2></td>
        <td align="right">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="180px">
                        <?php echo JText::_('COM_DJCATALOG2_ORDER_INVOICE_DATE')?>:
                    </td>
                    <td>
                        <?php echo JHTML::_('date', $data->invoice_date, 'd-m-Y'); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                        <?php echo JText::_('COM_DJCATALOG2_ORDER_SERVICE_DATE')?>:
                    </td>
                    <td>
                        <?php echo JHTML::_('date', $data->service_date, 'd-m-Y'); ?>
                    </td>
                </tr>
                <tr>
                    <td>
...
foreach ($data->items as $item) {
    ...
    <tr>
        ...
        <td align="center" style="padding: 10px 0;">
        	<?php echo $item->unit ? $item->unit : JText::_('COM_DJCATALOG2_UNIT_PC'); ?>
        </td>
        <td align="center" style="padding: 10px 0;">
