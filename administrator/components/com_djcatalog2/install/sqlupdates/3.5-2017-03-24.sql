ALTER TABLE `#__djc2_users` 
ADD `state_id` INT NOT NULL DEFAULT '0' AFTER `country_id`; 

ALTER TABLE `#__djc2_quotes` 
ADD `state` VARCHAR(100) NULL AFTER `country_id`, 
ADD `state_id` INT NULL DEFAULT '0' AFTER `state`; 

ALTER TABLE `#__djc2_orders` 
ADD `state` VARCHAR(100) NULL AFTER `country_id`, 
ADD `state_id` INT NULL DEFAULT '0' AFTER `state`;
 
ALTER TABLE `#__djc2_countries_states` 
ADD `state_code` VARCHAR(255) NULL AFTER `name`;
