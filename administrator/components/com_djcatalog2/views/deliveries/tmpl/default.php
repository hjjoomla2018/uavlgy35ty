...
?>
<form action="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=deliveries');?>" method="post" name="adminForm" id="adminForm">
		...
		<thead>
			<tr>
				...
				<th width="15%"  class="title">
					<?php echo JHTML::_('grid.sort',  'COM_DJCATALOG2_PLUGIN', 'a.plugin', $listDirn, $listOrder ); ?>
				</th>
				<th width="5%">
				...
				<th width="10%">
					...
					<?php if ($saveOrder) :?>
						<?php echo JHtml::_('grid.order',  $this->items, 'filesave.png', 'deliveries.saveorder'); ?>
					<?php endif; ?>
				</th>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_DJCATALOG2_EDIT_TOOLTIP' );?>::<?php echo $this->escape($item->name); ?>">
						<a href="<?php echo JRoute::_('index.php?option=com_djcatalog2&task=delivery.edit&id='.$item->id);?>">
				...
				<td class="center">
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'deliveries.', true, 'cb'	); ?>
				</td>
				<td class="order">
					<div class="input-prepend">
						<?php $disabled = ''; ?>
						<?php if ($saveOrder && $listDirn == 'asc') :?>
								<span class="add-on"><?php echo $this->pagination->orderUpIcon($i, true, 'deliveries.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ?></span><span class="add-on"><?php echo $this->pagination->orderDownIcon($i, $this->pagination->total, true, 'deliveries.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
