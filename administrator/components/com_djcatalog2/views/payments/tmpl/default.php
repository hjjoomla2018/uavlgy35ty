...
?>
<form action="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=payments');?>" method="post" name="adminForm" id="adminForm">
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_DJCATALOG2_EDIT_TOOLTIP' );?>::<?php echo $this->escape($item->name); ?>">
						<a href="<?php echo JRoute::_('index.php?option=com_djcatalog2&task=payment.edit&id='.$item->id);?>">
				...
				<td class="order">
					<div class="input-prepend">
						...
						<?php if ($saveOrder && $listDirn == 'asc') :?>
								<span class="add-on"><?php echo $this->pagination->orderUpIcon($i, true, 'payments.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ?></span><span class="add-on"><?php echo $this->pagination->orderDownIcon($i, $this->pagination->total, true, 'payments.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
