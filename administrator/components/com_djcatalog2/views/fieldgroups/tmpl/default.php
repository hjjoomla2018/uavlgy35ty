				...
				<td class="order">
						<div class="input-prepend">
							...
							<?php if ($saveOrder && $listDirn == 'asc') :?>
								<span class="add-on"><?php echo $this->pagination->orderUpIcon($i, true, 'fieldgroups.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ?></span><span class="add-on"><?php echo $this->pagination->orderDownIcon($i, $this->pagination->total, true, 'fieldgroups.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
