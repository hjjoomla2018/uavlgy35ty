		...
		<div class="djc_control_panel clearfix">
			<div class="cpanel-left">
				<div class="cpanel">
						...
						<div class="icon">
							<a href="index.php?option=com_djcatalog2&amp;view=orders">
								<img alt="<?php echo JText::_('COM_DJCATALOG2_ORDERS'); ?>" src="<?php echo JURI::base(); ?>components/com_djcatalog2/assets/images/icon-48-orders.png" />
								<span><?php echo JText::_('COM_DJCATALOG2_ORDERS'); ?></span>
							</a>
						</div>
