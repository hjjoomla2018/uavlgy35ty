...
<form action="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=order&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="order-form" class="form-validate" enctype="multipart/form-data">
	<div class="row-fluid">
		...
		<div class="span6 form-horizontal">
			<fieldset class="adminform">
			<legend><?php echo JText::_('COM_DJCATALOG2_ORDER_FIELDSET_DELIVERYPAYMENT'); ?></legend>
	...
	<div class="row-fluid">
		...
		<div class="span6 form-horizontal">
			<fieldset class="adminform">
			<legend><?php echo JText::_('COM_DJCATALOG2_ORDER_FIELDSET_DELIVERY'); ?></legend>
	        ...
	        <table class="admintable table table-striped ">
	            ...
	            foreach ($this->item->items as $row) { ?>
	                <tr>
	                    ...
	                    <td>
	                        <input name="jform[order_items][sku][<?php echo $row->id; ?>]" type="text" value="<?php echo $row->sku ?>" size="40" disabled="disabled"/>
	                    </td>
	                    <td>
	            ...
	            <?php } ?>
	                ...
	                <tr id="order_row_pattern" style="display:none">
	                    ...
	                    <td>
	                        <input name="jform[order_items][sku][]" type="text" value="" size="40" class="input input-medium" />
	                    </td>
	                    <td>
...
<script type="text/javascript">
    ...
    /*function invoiceFillUserData(user_id) {
        ...
        onSuccess: function(response) {
            var recProgressBar = document.getElementById('djc_progress_bar');
            var recProgressPercent = document.getElementById('djc_progress_percent');
