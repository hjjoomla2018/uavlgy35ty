...
<script type="text/javascript">
	...
	{
		if (task == 'delivery.cancel' || document.formvalidator.isValid(document.id('edit-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=delivery&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="edit-form" class="form-validate" enctype="multipart/form-data">
