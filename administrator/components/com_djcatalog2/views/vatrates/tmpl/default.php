...
?>
<form action="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=vatrates');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist table-striped table">
		<thead>
			<tr>
                ...
                <th width="5%">
                    <?php echo JHtml::_('grid.sort', 'COM_DJCATALOG2_TAX_RATE', 'a.value', $listDirn, $listOrder); ?>
                </th>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_DJCATALOG2_EDIT_TOOLTIP' );?>::<?php echo $this->escape($item->name); ?>">
						<a href="<?php echo JRoute::_('index.php?option=com_djcatalog2&task=vatrate.edit&id='.$item->id);?>">
							<?php echo $this->escape($item->name); ?></a>
						</span>
				</td>
				<td class="center">
                    <?php echo $item->country_name.' ['.$item->country_2_code.']'; ?>
                </td>
                <td class="center">
                    <?php echo JText::_('COM_DJCATALOG2_TAX_RULE_CLIENT_TYPE_'.strtoupper($item->client_type)); ?>
                </td>
				<td class="center">
